 ...
 * @group Theme
 */
class UnDateRangeTest extends TwigBase {
  ...
  public function testValidEnglish($expected = NULL, $variable = NULL, $format = NULL) {
    ...
    if ($this->inlineDataProvider) {
      ...
      foreach ($data as $name => $row) {
        ...
        $template = '{{ variable|un_daterange("' . $format . '") }}';
  ...
  public function providerValidTestDataNumeric() {
    return [
      __FUNCTION__ . '::UnDateRange1' => [
        'expected' => [
          'en' => '6.12.2023 10.11 a.m. — 2.11 p.m.',
          'fr' => '6.12.2023 10 h 11 — 14 h 11',
          'es' => '6.12.2023 10.11 horas',
          'ar' => '6.12.2023 10.11',
          'zh-hans' => '6.12.2023 10時11分',
        ],
      ...
      __FUNCTION__ . '::UnDateRange4' => [
        'expected' => [
          'en' => '6.12.2023 10 a.m. — 11 p.m.',
          'fr' => '6.12.2023 10 heures — 23 heures',
          'es' => '6.12.2023 10 horas',
          'ar' => '6.12.2023 10',
          'zh-hans' => '6.12.2023 10時正',
        ],
      ...
      __FUNCTION__ . '::UnDateRange6' => [
        'expected' => [
          'en' => '6.12.2023 midnight — 1 a.m.',
          'fr' => '6.12.2023 minuit — 1 heure',
          'es' => '6.12.2023 medianoche',
          'ar' => '6.12.2023 منتصف الليل',
          'zh-hans' => '6.12.2023 午夜',
        ],
      ...
      __FUNCTION__ . '::UnDateRange7' => [
        'expected' => [
          'en' => '6.12.2023 noon — 2 p.m.',
          'fr' => '6.12.2023 midi — 14 heures',
          'es' => '6.12.2023 mediodía',
          'ar' => '6.12.2023 وقت الظهيرة',
          'zh-hans' => '6.12.2023 中午',
        ],
